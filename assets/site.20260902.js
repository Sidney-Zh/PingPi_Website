...
const COPY = {
  en: {
    ...
    renameKicker: "PingPi is now SportArc",
    renameTitle: "We’ve changed our name.",
    renameCopy: "PingPi has been renamed SportArc. Continue with the current global website and App Store app.",
    renameWebsite: "Visit the SportArc website",
    renameStore: "View SportArc on the App Store",
    navCta: "App Store",
  ...
  "zh-CN": {
    ...
    renameKicker: "PingPi 现已更名为 SportArc",
    renameTitle: "我们已经更名。",
    renameCopy: "PingPi 已更名为 SportArc。请前往当前海外官网，或在 App Store 查看新版 App。",
    renameWebsite: "访问 SportArc 海外官网",
    renameStore: "在 App Store 查看 SportArc",
    navCta: "App Store",
  ...
  "zh-TW": {
    ...
    renameKicker: "PingPi 現已更名為 SportArc",
    renameTitle: "我們已經更名。",
    renameCopy: "PingPi 已更名為 SportArc。請前往目前的海外官網，或在 App Store 查看新版 App。",
    renameWebsite: "造訪 SportArc 海外官網",
    renameStore: "在 App Store 查看 SportArc",
    navCta: "App Store",
    heroEyebrow: "AI 桌球助手",
    heroTitleA: "復盤比賽。",
  ...
  de: {
    ...
    renameKicker: "PingPi heißt jetzt SportArc",
    renameTitle: "Wir haben unseren Namen geändert.",
    renameCopy: "PingPi wurde in SportArc umbenannt. Nutze ab jetzt die aktuelle globale Website und die App im App Store.",
    renameWebsite: "SportArc-Website öffnen",
    renameStore: "SportArc im App Store ansehen",
    navCta: "App Store",
  ...
  fr: {
    ...
    renameKicker: "PingPi s’appelle désormais SportArc",
    renameTitle: "Nous avons changé de nom.",
    renameCopy: "PingPi a été renommé SportArc. Retrouvez désormais l’app sur le site international actuel et dans l’App Store.",
    renameWebsite: "Visiter le site SportArc",
    renameStore: "Voir SportArc sur l’App Store",
    navCta: "App Store",
  ...
  ja: {
    ...
    renameKicker: "PingPi は SportArc に名称変更しました",
    renameTitle: "新しい名前になりました。",
    renameCopy: "PingPi は SportArc に名称変更しました。現在のグローバルサイトまたは App Store から新しい App をご利用ください。",
    renameWebsite: "SportArc 公式サイトを見る",
    renameStore: "App Store で SportArc を見る",
    navCta: "App Store",
  ...
  ko: {
    ...
    renameKicker: "PingPi가 SportArc로 이름을 바꿨습니다",
    renameTitle: "새 이름으로 만나보세요.",
    renameCopy: "PingPi는 이제 SportArc입니다. 현재 글로벌 웹사이트 또는 App Store에서 새 App을 이용해 주세요.",
    renameWebsite: "SportArc 웹사이트 방문",
    renameStore: "App Store에서 SportArc 보기",
    navCta: "App Store",
...
function render(locale) {
  ...
  setText("[data-rename-kicker]", copy.renameKicker);
  setText("[data-rename-title]", copy.renameTitle);
  setText("[data-rename-copy]", copy.renameCopy);
  setText("[data-rename-website]", copy.renameWebsite);
  setText("[data-rename-store]", copy.renameStore);
